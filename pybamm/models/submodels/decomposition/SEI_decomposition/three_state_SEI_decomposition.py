...
class ThreeStateSeiDecomposition(pybamm.BaseSubModel):
    ...
    **Extends:** :class:`pybamm.BaseSubModel`
    ...
    def get_coupled_variables(self, variables):
        ...
        # Q_exo_sei = Q_exo_sei(x_sei_core)
        ...
        variables = {
            "SEI decomposition reaction rate [s-1]": r_sei_dim(x_sei),
            "SEI decomposition reaction rate": r_sei_dim(x_sei, T_av_dim) * param.timescale,
            "SEI decomposition heating": Q_exo_sei(x_sei),
            "SEI decomposition heating [W.m-3]": Q_exo_sei(x_sei) * Q_scale,
